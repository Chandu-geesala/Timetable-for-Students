...
class TimetableScreen3 extends StatefulWidget {
  const TimetableScreen3({Key? key}) : super(key: key);

  @override
  State<TimetableScreen3> createState() => _TimetableScreenState();
}

class _TimetableScreenState extends State<TimetableScreen3> {
  ...
  switch (today) {
    case DateTime.monday:
      return [
        ...
        ClassEvent(subject: 'IOR', startTime: _getDateTime(16, 10), endTime: _getDateTime(17, 0)),
        ClassEvent(subject: 'YOGA', startTime: _getDateTime(17, 0), endTime: _getDateTime(17, 50)),
      ];
    case DateTime.tuesday:
      return [
        ClassEvent(subject: 'Career Guidance', startTime: _getDateTime(8, 40), endTime: _getDateTime(9, 30)),
        ClassEvent(subject: 'COA', startTime: _getDateTime(9, 30), endTime: _getDateTime(10, 20)),
        ClassEvent(subject: 'DSP', startTime: _getDateTime(10, 20), endTime: _getDateTime(11, 10)),
        ClassEvent(subject: 'WT', startTime: _getDateTime(11, 20), endTime: _getDateTime(12, 10)),
        ClassEvent(subject: 'CD', startTime: _getDateTime(12, 10), endTime: _getDateTime(13, 0)),
      ];
    case DateTime.wednesday:
      return [
        ClassEvent(subject: 'DSP Lab', startTime: _getDateTime(13, 30), endTime: _getDateTime(16, 10)),
        ClassEvent(subject: 'IOR', startTime: _getDateTime(16, 10), endTime: _getDateTime(17, 0)),
        ClassEvent(subject: 'SPORTS', startTime: _getDateTime(17, 0), endTime: _getDateTime(17, 50)),
